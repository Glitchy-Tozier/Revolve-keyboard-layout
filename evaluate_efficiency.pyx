...
plot "results/2010-03-29-evolve-range-final-penalty.txt" title "final penalty in billion points", 2.048361472 title "Qwertz final penalty", 1.380194974 title "neo final penalty"
plot "results/2010-03-29-evolve-range-finger-repeats.txt" title "Finger repeats in percent", 4.82198888113 title "Neo for comparision", 6.72632774411 title "Qwertz for comparision"
plot "results/2010-03-29-evolve-range-finger-disbalance.txt" title "finger disbalance [million keystrokes]", 7.75577431662 title "Qwertz finger disbalance [million keystrokes]", 4.56473130298 title "Neo finger disbalance [million keystrokes]"
plot "results/2010-03-29-evolve-range-key-position.txt" title "mean key position cost", 5.95987411112 title "Qwertz mean key position cost", 3.9755737368 title "Neo mean key position cost"
