...
WEIGHT_NO_HANDSWITCH_AFTER_DIRECTION_CHANGE = 1 #: how much stronger should the triple without handswitch be counted, if there also is a direction change? Also affects the “unweighted” result from total_cost!
WEIGHT_NO_HANDSWITCH_WITHOUT_DIRECTION_CHANGE = 0 #: how much stronger should the triple without handswitch be counted, if there also is a direction change? Also affects the “unweighted” result from total_cost!
...
COST_PER_KEY  = [ # the 0 values aren’t filled in at the moment. 
    ...
    [0,    18, 10, 6, 5, 6,    9, 10, 5, 4, 5, 8,12, 18], # Reihe 1
    [0,     5, 3, 3, 3, 3,     5, 5, 3, 3, 3, 3,5,10], # Reihe 2
    [20,15,10,12,12, 10,   10, 15, 7, 6,11,11,   12],     # Reihe 3
...
FINGER_POSITIONS = {
    "Klein_L": [(1, 1, 0), (1, 2, 0), (2, 0, 0), (2, 1, 0), (2, 2, 0), (3, 0, 0), (3, 1, 0), (3, 2, 0)], # Klein_L
    "Ring_L": [(1, 3, 0), (2, 3, 0), (3, 4, 0)], # Ring_L
    "Mittel_L": [(1, 4, 0), (2, 4, 0), (3, 5, 0)], # Mittel_L
    "Zeige_L": [(1, 5, 0), (2, 5, 0), (3, 6, 0), (1, 6, 0), (2, 6, 0), (3, 7, 0)], # Zeige_L
    "Daumen_L": [(4, 3, 0)], # Daumen_L
    "Daumen_R": [(4, 3, 0)], # Daumen_R
    "Zeige_R": [(1, 7, 0), (2, 7, 0), (3, 8, 0), (1, 8, 0), (2, 8, 0), (3, 9, 0)], # Zeige_R
    "Mittel_R": [(1, 9, 0), (2, 9, 0), (3, 9, 0)], # Mittel_R
    "Ring_R": [(1, 10, 0), (2, 10, 0), (3, 11, 0)], # Ring_R
    "Klein_R": [(1, 11, 0), (2, 11, 0), (3, 12, 0), (1, 12, 0), (2, 12, 0), (2, 13, 0)] # Klein_R
}
