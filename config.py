...
WEIGHT_FINGER_SWITCH = 10 #: how much worse is it to switch from middle to indexfinger compared with middle to pinky (~30ms according to Rohmert).
...
COST_PER_KEY  = [
    ...
    [24,    20, 6, 4, 6, 9,    10, 5, 4, 5, 8,24,36, 0], # Reihe 1
