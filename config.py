...
WEIGHT_FINGER_DISBALANCE = 400 #: multiplied with the standard deviation of the finger usage - value 
guessed and only valid for the 1gramme.txt corpus. 
...
COST_PER_KEY  = [
    ...
    [15,12, 16,24,20, 5,    30, 6, 5,22,22,13,      15],     # Reihe 3
