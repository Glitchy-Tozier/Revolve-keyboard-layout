...
COST_PER_KEY  = [
    ...
    [18,16, 17,24,20,9,   30,  10, 8,22,22,17,       19],     # Reihe 3
...
WEIGHT_FINGER_REPEATS = 1000 #: Cost of a finger repeat. Gets additional +1 from the row change on the same finger.
...
#    ((1, 9, 0), (2, 8, 0)): 0.1, # ok on normal keyboards (lower row shifted to the right)
    ...
    ((3, 2, 0), (2, 2, 0)): 0.3, # sz on normal keyboards (lower row shifted to the right)
    ((2, 2, 0), (3, 2, 0)): 0.3, # zs on normal keyboards (lower row shifted to the right)
