...
FINGER_POSITIONS = {
    "Klein_L": [(0, 0, 0), (0, 1, 0), (0, 2, 0), (1, 1, 0), (2, 0, 0), (2, 1, 0), (3, 0, 0), (3, 1, 0), (3, 2, 0), (4, 0, 0), (4, 1, 0)], # Klein_L
    ...
    "Klein_R": [(0, 11, 0), (0, 12, 0), (0, 13, 0), (1, 10, 0), (2, 10, 0), (3, 11, 0), (1, 11, 0), (2, 11, 0), (1, 12, 0), (2, 12, 0), (2, 13, 0), (3, 12, 0), (4, 5, 0), (4, 6, 0), (4, 7, 0)] # Klein_R
}
...
WEIGHT_FINGER_REPEATS_TOP_BOTTOM = 10000 #: Additional cost of a finger repetition from the top to the bottom line. Gets added to the cost of the normal finger repetition. Additionally this gets costs as row repetition on the same hand (+4). 


## Line changes

WEIGHT_BIGRAM_ROW_CHANGE_PER_ROW = 5 #: When I have to switch the row in a bigram while on the same hand, that takes time => Penalty per (row to cross ² / horizontal distance)² if we’re on the same hand. 
...
WEIGHT_NEIGHBORING_UNBALANCE = 240 #: The penalty for an unbalancing key following after a neighboring finger or vice versa. Wolfs Value: 5
