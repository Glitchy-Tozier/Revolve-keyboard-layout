...
def evolve_a_layout(steps, prerandomize, controlled, quiet, meter, verbose, controlled_tail, starting_layout=NEO_LAYOUT, datafile=None, anneal=0, anneal_step=100, quadratic=False):
